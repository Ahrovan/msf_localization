...
SensorStateCore::SensorStateCore(const std::weak_ptr<MsfElementCore> msf_element_core_ptr) :
...
int SensorStateCore::setPositionSensorWrtRobot(const Eigen::Vector3d &positionSensorWrtRobot)
{
...
int SensorStateCore::setAttitudeSensorWrtRobot(const Eigen::Vector4d& attitudeSensorWrtRobot)
{
